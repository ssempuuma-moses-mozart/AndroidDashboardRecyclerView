...
import com.example.ulcerpatientapp.Adapter.DoctorViewDoctorAdapter;
 ...
 * Use the {@link DoctorViewDoctorFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DoctorViewDoctorFragment extends Fragment {

    RecyclerView recyclerView;
    DoctorViewDoctorAdapter adapter;
    ...
    public DoctorViewDoctorFragment() {
        // Required empty public constructor
    }

    public static DoctorViewDoctorFragment newInstance(String param1, String param2) {
        DoctorViewDoctorFragment fragment = new DoctorViewDoctorFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_doctor_view_doctor, container, false);

        //Assigning the Recyclerview to display notifications
        recyclerView = (RecyclerView) view.findViewById(R.id.DoctorViewDoctorRecyclerView);
...
//        search_input=view.findViewById(R.id.home_search_edit_text);
        ...
        adapter = new DoctorViewDoctorAdapter(getContext(), mModel);
