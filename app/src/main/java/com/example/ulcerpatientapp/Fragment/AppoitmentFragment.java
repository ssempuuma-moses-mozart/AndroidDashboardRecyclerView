...
public class AppoitmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_appoitment, container, false);

        //Assigning the Recyclerview to display notifications
        recyclerView = (RecyclerView) view.findViewById(R.id.AppointmentRecyclerView);
...
//        search_input=view.findViewById(R.id.home_search_edit_text);
        ...
        adapter = new AppointmentAdapter(getContext(), mModel);
