    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PatientLoginRegisterChoice.this, PatientLoginActivity.class).putExtra("ForPatient",true));
        ...
        register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PatientLoginRegisterChoice.this,PatientRegisterActivity.class));
